...
CLONE_DATABASE_URI = environ.get('CLONE_DATABASE_URI', "mongodb+srv://mogode3996:D96XSFbqWQ9thyP3@cluster0.6kmff.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") # Necessary If clone mode is true
PUBLIC_FILE_CHANNEL = environ.get('PUBLIC_FILE_CHANNEL', 'publicfilechannel1245') # Public Channel Username Without @ or without https://t.me/ and Bot Is Admin With Full Right.
