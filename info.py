...
PICS = (environ.get('PICS', 'https://graph.org/file/97376f51bde1b08a14ff4-15e88bfc9f2edf8c4c.jpg')).split()
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001970263676') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://pyaaraislamofficial:5p2Mf6v9iiqp1Bux@cluster0.d4gfw.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://graph.org/file/85028ea7093792d26f7b7-a1c26942bf0465b09e.jpg') # payment code picture url.
PAYMENT_TEXT = environ.get('PAYMENT_TEXT', '<b>💰💳𝐇𝐞𝐲 𝐏𝐫𝐞𝐦𝐢𝐮𝐦 𝐏𝐥𝐚𝐧𝐬 💲 \✅New Plans For TV Shows Premium Channel😍|[MRN Premium Tv, 🎞All Indian Hindi TV Shows ]\
\━━━━━━━━━━━━━━━━━━━━\⚡️>>> Rs. 75 -  1 Month\⚡️>>> Rs. 140 - 2 Monthè⚡️>>> Rs. 215 -  3 Month\⚡️>>> Rs. 290 -  4 Month\⚡️>>> Rs. 365 -  5 Month\<code>9106193037@ibl</code>\🚨These Prices Are Now Permanent Plans.\✅1-Day Demo/Trial Also Available Here.\OTT: Hotstar, ZEE5, JioCinema, SONYLIV, DangalPlay, 
ShemarooMe, EpicOn Etc. all OTT Movies and Webseries available\⚡️Grab It Fast ASAP😘 [💯Trusted]\👨‍💻Contact Us @mimam_officialx\⚠️𝗦𝗲𝗻𝗱 𝗦𝗦 𝗔𝗳𝘁𝗲𝗿 𝗣𝗮𝘆𝗺𝗲𝗻𝘁⚠️ 𝗔𝗳𝘁𝗲𝗿 𝘀𝗲𝗻𝗱𝗶𝗻𝗴 𝗮 𝗦𝗰𝗿𝗲𝗲𝗻𝘀𝗵𝗼𝘁 𝗽𝗹𝗲𝗮𝘀𝗲 𝗴𝗶𝘃𝗲 𝘂𝘀 𝘀𝗼𝗺𝗲 𝘁𝗶𝗺𝗲 𝘁𝗼 𝗮𝗱𝗱 𝘆𝗼𝘂 𝗶𝗻 𝘁𝗵𝗲 𝗽𝗿𝗲𝗺𝗶𝘂𝗺 𝘃𝗲𝗿𝘀𝗶𝗼𝗻｡｡</b>)
...
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', '2819a959174f367d970d3fab75634fa88f8b8f25')
