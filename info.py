...
BOT_TOKEN = environ.get('BOT_TOKEN', "6975829827:AAFBG9RAxF34g23a3pI06BmIi-UcFb0wtpk")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://i.ibb.co/Vct3VvNN/photo-2025-03-31-12-32-54-7499550710325837840.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7009595359 1416841137').split()] # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002007663918') # give your force subscribe channel id here else leave it blank
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002241085618')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None

# This Channel Is For /batch command file store.
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002650912983')).split()]  # For Multiple Id Use One Space Between Each.
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002522878012').split()]  # For Multiple Id Use One Space Between Each.


# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://solo:wfMoVEPLT6467qUf@cluster0.sxpg6sh.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "solo")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'users')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+19G-vowas6M3MGU1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+gE8Utdmvn4kzZjE1')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'srkassistant') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/otakusolo')
