...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002416164217 -1002370123896 -1002423454296 -1002440315747').split()]  # For Multiple Id Use One Space Between Each.
