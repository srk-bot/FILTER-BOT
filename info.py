...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002689364893').split()]  # For Multiple Id Use One Space Between Each.
...
reqst_channel = environ.get('REQST_CHANNEL', '-1002662471092')
...
F_DB_URI = environ.get('F_DB_URI', "https://t.me/+UxKRKuVeJlswYzBl")   # This Db Is For File Data Store
S_DB_URI = environ.get('S_DB_URI', "https://t.me/+X2I1yg-OXK8wMWY1")   # This Db is for File Data Store When First Db Is Going To Be Full.
