...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7293207200').split()] # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002684322211').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002552538980') # give your force subscribe channel id here else leave it blank
...
DATABASE_NAME = environ.get('DATABASE_NAME', "luckyraj")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'lucky')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'luckyji79302') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', '@Lucky77A7')
