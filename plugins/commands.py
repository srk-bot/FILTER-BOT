...
async def start(client, message):
    ...
    if data.split("-", 1)[0] == "BATCH":
        ...
        if is_valid == True:
            text += "<b>ʜᴇʏ {} 👋,\n\nʏᴏᴜ ᴀʀᴇ ɴᴏᴛ ᴠᴇʀɪғɪᴇᴅ ᴛᴏᴅᴀʏ, ᴘʟᴇᴀꜱᴇ ᴄʟɪᴄᴋ ᴏɴ ᴠᴇʀɪғʏ & ɢᴇᴛ ᴜɴʟɪᴍɪᴛᴇᴅ ᴀᴄᴄᴇꜱꜱ ғᴏʀ ᴛɪʟʟ ɴᴇxᴛ ᴠᴇʀɪғɪᴄᴀᴛɪᴏɴ/n/nअगर आप Bot से 📁 फाइल लेना चाहते है तो पहले आपको Bot को वेरीफाई करना होगा |/n/nअन्यथा आप फाइल नहीं ले सकते/n/nवेरिफाई करने के लिए Tutorial वीडियो देखें 👇 ☺️\n\n💶 ꜱᴇɴᴅ /plan ᴛᴏ ʙᴜʏ ꜱᴜʙꜱᴄʀɪᴘᴛɪᴏɴ</b>"
            if PREMIUM_AND_REFERAL_MODE == True:
